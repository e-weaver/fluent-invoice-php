...
<head>
    ...
    <style>
        ...
        .invoice-box { max-width: 800px; margin: auto; padding: 40px; background: #ffffff; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.05); <?php if($hasBorder): ?>border: 2px solid <?= htmlspecialchars($color) ?>;<?php endif; ?> }
